  ...
  return (
    ...
    >
      <div style={{ flex: 1, minWidth: 200 }}>
        ...
        >
          Show this public QR pass to organizers.
        </p>
        ...
        >
          ...
          <div>
            <strong style={{ color: "var(--text-secondary)" }}>Passes:</strong>{" "}
            <span style={{ color: "var(--text-primary)", fontWeight: 600 }}>
...
export default function Registrations({ currentUser }) {
  ...
  const openWhatsApp = (res) => {
    ...
    let answersObj = {};
    try {
      answersObj = JSON.parse(res.answers || "{}");
    } catch (e) {
      /* ignore */
    }
    const msg = buildRegistrationMessage({
      eventName: m?.title || "Perenti Meetup",
      userName: res.user_name || currentUser?.name || "",
      email: res.user_email || currentUser?.email || "",
      mobile: answersObj.mobile || "",
      passes: res.quantity || 1,
      role: answersObj.role || "",
      building: answersObj.building || "",
      lookingFor: answersObj.lookingFor || "",
      amount: (res.quantity || 1) * (m?.price || 422),
    });
              ...
              {pendingReservations.map((res) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      background: "var(--bg-card)",
                      border: "1.5px solid rgba(255,113,1,0.3)",
                      borderRadius: 16,
                      overflow: "hidden",
                    }}
                  >
                    <div
                      style={{
                        ...
                        alignItems: "center",
                        justifyContent: "space-between",
                        borderBottom: "1px solid rgba(255,113,1,0.15)",
                      }}
                    >
                      <span
                        style={{
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <span>
                            {res.quantity}{" "}
                            {res.quantity === 1 ? "Pass" : "Passes"} · ₹
                            {res.quantity * (res.meetup?.price || 422)}
                          </span>
                        </div>
                      </div>
                      ...
                      >
                        {[
                          ...
                          { n: "2", t: "Screenshot the payment confirmation" },
                          {
                            n: "3",
                            t: "Tap the WhatsApp button — details are pre-filled",
                          },
                          {
                            n: "4",
                            t: "Admin will verify and approve your pass",
                          },
                        ].map((s) => (
                          <div
                            key={s.n}
                      ...
                      >
                        ...
                        >
                          Amount: ₹{res.quantity * (res.meetup?.price || 422)}
                        </div>
                      </div>
                      ...
                      >
                        Your registration details are pre-filled. Attach payment
                        screenshot and send.
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {res.quantity}{" "}
                          {res.quantity === 1 ? "Attendee" : "Attendees"}
                        </span>
                      </div>
