...
export default function Settings({ onLogout, currentUser }) {
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: "0.875rem", color: "var(--text-secondary)" }}>
            These details are displayed on your public profile. Anyone can see
            them.
          </div>
  ...
  return (
    <div
      style={{ display: "flex", height: "100%", background: "var(--bg-card)" }}
    >
                    ...
                    >
                      ...
                      >
                        <Icon
                          size={18}
                          color={
                            isActive ? "var(--primary)" : "var(--text-primary)"
                          }
                        />
                      </div>
                      <div
                      ...
                      {item.badge && (
                        <div
                          style={{
                            fontSize: "0.6875rem",
                            fontWeight: 600,
                            background: "rgba(3,212,124,0.15)",
                            color: "var(--primary)",
                            padding: "2px 8px",
                            borderRadius: 999,
                          }}
