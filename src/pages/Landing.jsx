...
export default function Landing({ onLogin, theme, toggleTheme }) {
  ...
  const founders = Array.isArray(members)
    ? members.filter((m) => m?.tags?.includes("Founder")).length
    : 0;
  const [marqueeMembers, setMarqueeMembers] = useState([]);
  useEffect(() => {
    setMarqueeMembers(
      Array.isArray(members)
        ? [...members].sort(() => 0.5 - Math.random()).slice(0, 18)
        : []
    );
  }, [members]);
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
          ...
          <button className="btn btn-ghost btn-sm" onClick={goToLogin}>
            Sign In
          </button>
          <button
      ...
      <main style={{ flex: 1 }}>
        ...
        >
          <div>
            ...
            >
              Perenti brings together founders, investors, and professionals through
              curated monthly meetups and a verified member directory.
            </p>
        ...
        {/* CTA BLOCK */}
        <section
          style={{ padding: "0 48px 72px", maxWidth: 1100, margin: "0 auto" }}
        >
          <div
            style={{
              background: "var(--primary-glow)",
          ...
          >
            ...
            >
              Sign up with your email, complete your profile, and start
              connecting with Hyderabad's most driven builders.
            </p>
            <button
              className="btn btn-primary"
              style={{
                ...
                borderRadius: 999,
                fontWeight: 600,
                boxShadow: "0 6px 24px rgba(3,212,124,0.2)",
              }}
              onClick={goToLogin}
            >
              Create Free Account
      ...
      >
        <span
          style={{
            ...
            background:
              "linear-gradient(180deg, var(--text-primary) 15%, transparent 100%)",
